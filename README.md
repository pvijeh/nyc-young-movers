...
So far: the Census estimates show the young-adult population of Manhattan growing by net migration at least as fast in the 2020s as in the 2010s. The IRS data shows arrivals into Manhattan and the city drifting down from 2012 to 2021, then jumping in 2022 and 2023, and shows the share of young in-movers to New York State with AGI under $50,000 falling from 89% to 64%, a shift that is mostly inflation and can't be read as fewer poor arrivals yet.
...
2. **The AGI bands are in nominal dollars.** $50,000 in 2012 is about $66,000 in 2023 dollars. A filer earning the same real wage moved up roughly one band over the period, so most of the fall in the under-$50k share is inflation, not a change in who arrives. The IRS does not publish bands by age in constant dollars. The test in real dollars needs ACS PUMS, where income is a continuous number.
